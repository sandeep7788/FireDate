package com.videocall.datingapp.Swipe;
...
import com.videocall.datingapp.Matches.MatchesClass;
import com.videocall.datingapp.Extra.NopesClass;
...
public class SwipeFragment extends Fragment implements CardStackListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        imageViewProfileViewLovesBoost.setVisibility(View.GONE);
                                    ...
                                    if (stringCheckGender.equals("Any")) {
                                        ...
                                        if (profileClass.getUser_gender().equals(stringCheckGender)) {
                                            ...
                                            if (intBirthage >= intLookageMin && intBirthage <= intLookageMax) {
                                                ...
                                                if (stringCheckLocation != null && stringCheckLocation.equals("Anywhere")) {
